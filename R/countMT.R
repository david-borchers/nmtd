...
#' **sum** of times to detection for all detected  animals with in the site on the occasion 
...
#' @title Evaluates the negeative log-likelihood for model Count:MT with lambda depending 
#' on a covariate.
#'
#' @description
#' Evaluates the negeative log-likelihood for model Count:MT, assuming that lambda 
...
#' animals in the site depends linearly (assumed to be the same for all occasions).
#' 
#' @return Returns the negative log-likelihood function for model Count:MT evaluated at 
